...
@WebServlet("/obusinesspartners")
public class OriginalBusinessPartnerServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = CloudLoggerFactory.getLogger(OriginalBusinessPartnerServlet.class);
